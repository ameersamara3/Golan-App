...
public class AreasView extends Fragment {
    private ArrayList<Area> areaList;
    private RecyclerView recyclerView;
    private LocationRequest locationRequest;
    private FireBase fb;
    private RecyclerAdapterAreas adapter;
    ...
    public void onStart() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Add_Area fragment = new Add_Area();
        ...
        ma.setActionTitle("אזורים");
        //areaList=db.getOrders(MainActivity.user.getUsername());
        //if(MainActivity.longitude!=-1 && MainActivity.latitude!=-1){
    ...
    private void getAreas(){
        ...
        fb.getAreas(MainActivity.longitude,MainActivity.latitude,this);
    }
    public void setupAdapter(ArrayList<Area> areaList){
        if(!areaList.isEmpty()) {
                ...
                public void onLongClick(View view, int position) {
                    ...
                    builder.setNegativeButton("מחק", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(fb.deleteArea(areaList.get(position).getName())) {
                                //remove and refresh
            ...
            //setting up adapter
            adapter = new RecyclerAdapterAreas(areaList,getFragmentManager(),getActivity());
